...
support for merging YAML documents.
...
- [[#apply-merging-yaml-documents][YAML editing]] via ~apply~ action for merging documents (new in Rust version)
...
YAML data in shell scripts* and *merging YAML documents*. If you need
more, excellent alternatives exist.
...
| *shyaml-rs* | Rust | [[https://github.com/pantoniou/libfyaml][libfyaml]] | 1.2 | merge | dot-notation | *simple* |
...
- Just need to extract values from YAML files
...
- Need in-place editing or arbitrary modifications
